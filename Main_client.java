...
public static void main(String[] args) {
    ...
    final String serverHost = "localhost";
       ...
       try {
        ...
        String Version_os ="OS version os="+operatingSystemMXBean.getVersion();
        String processeur="Nombre de coeur="+operatingSystemMXBean.getAvailableProcessors()+"";
        String architecture="Architecture="+operatingSystemMXBean.getArch();
        String nom_win="Version windows="+operatingSystemMXBean.getName();
